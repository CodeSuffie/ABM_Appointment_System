...
public sealed class PalletFactory : IFactoryService<Pallet>
{
    ...
    private readonly UpDownCounter<int> _unclaimedPallets;
        ...
        Meter meter)
    {
        ...
        _unclaimedPallets =
            meter.CreateUpDownCounter<int>("pallet-unclaimed", "Pallet", "#Pallets unclaimed (excl. completed).");
    }
